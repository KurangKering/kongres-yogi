                ...
                <div class="card">
                    <div class="card-body">
                        <div class="text-center">
                            ...
                            <p>Bukti pembayaran dengan <b>No Pendaftaran <?= $data['pendaftaran']['id_pendaftaran'] ?></b> atas nama <b><?= $data['pendaftaran']['nama'] ?></b> berhasil disubmit. Hasil verifikasi bukti pembayaran akan diumumkan melalui email. Silahkan cek email secara berkala. </p>
